...
const Photo1 = "/image/ableton/photo-1.jpg";
const Photo2 = "/image/ableton/photo-2.jpg";

export default function AbletonMainCollage1() {
  return (
    <div className="relative mb-[8.33333vw] min-[1600px]:mb-[133.33333px]">
      <div className="w-[58.33333vw] h-[58.33333vw] bg-app01_paleYellow absolute right-0 min-[1600px]:w-[933.33333px] min-[1600px]:h-[933.33333px]" />
