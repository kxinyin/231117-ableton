...
export default function TestingDrawer() {
  const [isOpen, setIsOpen] = useState(false);

  return (
    <div className="border-solid border-2 bg-slate-400 h-full">
      ...
      <div
        id="drawer-backdrop"
        class={`fixed h-screen z-50 top-0 left-0  p-4 overflow-y-auto transition-transform ${
